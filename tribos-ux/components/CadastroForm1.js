  ...
  return (
    <>
      <div className={styles.dashboard_form_container}>
        ...
        <div className={styles.dashboard_form_localidade_inputs}>
        ...
        <fieldset className={styles.dashboard_form_descricao_input}>
          ...
          <textarea
            className={styles.dashboard_form_descricao_input_placeholder}
            type="text"
        ...
        <div className={styles.dashboard_form_redes_inputs}>
