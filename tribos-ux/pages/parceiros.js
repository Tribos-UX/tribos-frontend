            ...
            <div className={styles.container_partners}>
                <div className={styles.partners}>
                    <div className={styles.partners_description}>
                        ...
                        <p>
                            Envie sua proposta de parceria através do nosso formulário de contato e faça a diferença na comunidade!
                        </p>
                    ...
                    <Image className={styles.womanpartners_img} src={womanDistance} alt="Businesswoman looking into distance image" width={731} height={513} />
                </div>
            </div>
            <div className={styles.our_partners}>
                <Image className={styles.framepartners} src={framePartners} alt="UX Tribos Partners" width={1150} height={152} />
            </div>
            <div className={styles.partners_benefits}>
                <h1>Benefícios de ser um parceiro UX Tribos</h1>
                <div className={styles.framebenefits}>
                    <Image src={frameVisibility} alt="UX Partners Frame Visibility" width={321} height={420} />
                    <Image src={frameDialog} alt="UX Partners Frame Dialog" width={320} height={462} />
                    <Image src={frameNetworking} alt="UX Partners Frame Networking" width={320} height={460} />
                </div>
            </div>
        </div>
    )
