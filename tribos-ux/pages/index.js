        ...
        <div className={styles.container}>
          <div className={styles.funcionalidades_card}>
            ...
            <p className={styles.funcionalidades_descricao}>
              Organize seu grupo de estudos com outras pessoas e descubra o
              poder do trabalho em equipe e da colaboração no aprendizado.
            </p>
          </div>
          <div className={styles.funcionalidades_card}>
            <Image
            ...
            <p className={styles.funcionalidades_descricao}>
              ...
              pessoas vão trabalhar em um projeto para que possam demonstrar
          ...
          <div className={styles.funcionalidades_card}>
            ...
            <p className={styles.funcionalidades_descricao}>
              Conheça pessoas de diferentes regiões do país, troque e
              compartilhe conhecimentos e experiências, melhorando assim, suas
